...
The runtime environment of urge-monitor is setup with a given script (\textit{setup-environment.sh} in the source root of this project). The runtime environment is a python virtual environment that contains all dependencies. To run the environment setup script you need a Python3, Python3-venv and pip3 installed.

...
class ColorHelpersTest(unittest.TestCase):
    ...
    def test_ColorValidator_validateColorSpace_withInvalidColorSpace_raises(self):
    ...
    def test_ColorValidator_validateColorSpace_withValidColorSpace_passes(self):
        validator = helpers.ColorValidator()
    ...
    def test_ColorValidator_validateColor_withInvalidColorSpace_raises(self):
        validator = helpers.ColorValidator()
    ...
    def test_ColorValidator_validateColor_withValidRGB_passes(self):
        validator = helpers.ColorValidator()
    ...
    def test_ColorValidator_validateColor_withInvalidRGB_raises(self):
        validator = helpers.ColorValidator()
    ...
    def test_ColorValidator_validateColor_withValidRGB255_passes(self):
        validator = helpers.ColorValidator()
        validator.validateColor('rgb255', (0,0,0))
        validator.validateColor('rgb255', (0,127,255))
        validator.validateColor('rgb255', (255,255,255))

    def test_ColorValidator_validateColor_withInvalidRGB255_raises(self):
        validator = helpers.ColorValidator()
    ...
    def test_ColorValidator_validateColor_withValidHSV_passes(self):
        validator = helpers.ColorValidator()
        validator.validateColor('hsv', (0,0,0))
        validator.validateColor('hsv', (360,1,1))
        validator.validateColor('hsv', (180,0.5,0.333))

    def test_ColorValidator_validateColor_withInvalidHSV_raises(self):
        validator = helpers.ColorValidator()
    ...
    def test_ColorspaceTransformator_rgb255_to_rgb_validValue(self):
    ...
    def test_ColorspaceTransformator_rgb255_to_rgb_invalidValue(self):
        transformator = helpers.ColorspaceTransformator()
    ...
    def test_ColorspaceTransformator_rgb255_to_rgb255_validValue(self):
        transformator = helpers.ColorspaceTransformator()
    ...
    def test_ColorspaceTransformator_rgb255_to_rgb255_invalidValue(self):
        transformator = helpers.ColorspaceTransformator()
    ...
    def test_ColorspaceTransformator_rgb255_to_hsv_validValue(self):
        transformator = helpers.ColorspaceTransformator()
    ...
    def test_ColorspaceTransformator_rgb255_to_hsv_invalidValue(self):
        transformator = helpers.ColorspaceTransformator()
    ...
    def test_ColorspaceTransformator_rgb_to_rgb255_validValue(self):
        transformator = helpers.ColorspaceTransformator()
    ...
    def test_ColorspaceTransformator_rgb_to_rgb255_invalidValue(self):
        transformator = helpers.ColorspaceTransformator()
    ...
    def test_ColorspaceTransformator_rgb_to_rgb_validValue(self):
        transformator = helpers.ColorspaceTransformator()
    ...
    def test_ColorspaceTransformator_rgb_to_rgb_invalidValue(self):
        transformator = helpers.ColorspaceTransformator()
    ...
    def test_ColorspaceTransformator_rgb_to_hsv_validValue(self):
        transformator = helpers.ColorspaceTransformator()
    ...
    def test_ColorspaceTransformator_rgb_to_hsv_invalidValue(self):
        transformator = helpers.ColorspaceTransformator()
    ...
    def test_ColorspaceTransformator_hsv_to_rgb_validValue(self):
        transformator = helpers.ColorspaceTransformator()
    ...
    def test_ColorspaceTransformator_hsv_to_rgb_invalidValue(self):
        transformator = helpers.ColorspaceTransformator()
    ...
    def test_ColorspaceTransformator_hsv_to_rgb255_validValue(self):
        transformator = helpers.ColorspaceTransformator()
    ...
    def test_ColorspaceTransformator_hsv_to_rgb255_invalidValue(self):
        transformator = helpers.ColorspaceTransformator()
    ...
    def test_ColorspaceTransformator_hsv_to_hsv_validValue(self):
        transformator = helpers.ColorspaceTransformator()
    ...
    def test_ColorspaceTransformator_hsv_to_hsv_invalidValue(self):
        transformator = helpers.ColorspaceTransformator()
